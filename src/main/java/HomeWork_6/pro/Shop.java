package HomeWork_6.pro;

import HomeWork_5.Inteface.SellTelefonAddPhone;
import HomeWork_5.Inteface.SellTelefonCrate;
import HomeWork_5.Inteface.SellTelefonSell;

import java.util.ArrayList;
import java.util.Scanner;

public class Shop implements SellTelefonCrate, SellTelefonSell, SellTelefonAddPhone {
    ...
    public ArrayList<Telefon> addPhone(ArrayList<Telefon> listTelefon) {
        ...
        sc.close();
//        phone.
//    (factory, model, size, quantity, os, price);
